...
# (e) 표본상관계수를 계산하시오 (cor() 사용금지). [10점]
# (f) anscombe 데이터셋을 통해 상관계수만으로는 데이터의 특성을 완전히 파악하기 어렵다는 점을 설명하시오. [10점]
...
# (c) 위 문제를 고려했을 때, 그림과 같이 초기하분포와 이항분포가 유사함을 보이고, 어떤 조건에서 근사가 잘 되는지 설명하시오. [10점]
